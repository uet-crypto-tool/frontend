...
buildForm.addEventListener("submit", (event) => {
    ...
    fetch("http://localhost:8000/crypto_system/elgamal/generate_key", {
        method: "POST",
        headers: {
...
function encryptText() {
    ...
    fetch("http://localhost:8000/crypto_system/elgamal/encrypt", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
        ...
        .then((result) => {
            console.log(result);
            document.getElementById("y1-integer-encrypt").value = result.encrypted_message[0];
            document.getElementById("y2-integer-encrypt").value = result.encrypted_message[1];
        })
        .catch((error) => {
            console.error("Error:", error);
        });
...
function decryptText() {
    ...
    fetch("http://localhost:8000/crypto_system/elgamal/decrypt", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
